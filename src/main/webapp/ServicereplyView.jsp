...
<body>
	...
	<section>
	   	...
	   	<table border="1" align="center" height="800px" width="1200px">
   	...
   	<c:if test="${servicereplyData ne null}">
   		...
   		<tr>
 			...
 			<td><button type="button" class="edit-btn" value="uuid">수정</button><button class="delete-btn" value="uuid">삭제</button></td>
 			
   			
   		</tr>
 
   		</c:forEach>
   	<td><button class="edit-btn" value="uuid">수정</button><button class="delete-btn" value="uuid">삭제</button></td>
   	</c:if>
