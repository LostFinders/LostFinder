	...
	<body>
		...
		<table border="1" align="center" width="800px">
			...
			<c:if test="${lostfinderreplyData ne null}">.
				<c:forEach var="i" items="${lostfinderreplyData}" begin="0"
					end="${fn:length(lostfinderreplyData)}" step="1">
					<tr>
						<td height='40px'>${i.member_id}
						<td>${i.reply_content}
						<td>${i.reply_createdate}
							<button class="reply-edit" value="${i.reply_uuid }">댓글 수정</button>
							<button class="reply-delete" value="${i.reply_uuid }">댓글 삭제</button>
					</tr>
